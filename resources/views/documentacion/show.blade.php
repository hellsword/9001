    ...
    <div class="widgetcontent bordered shadowed nopadding" id="formulario">
        <div class="stdform stdform2">
           ...
           @foreach($documentos as $documento)
            ...
            <td> <a href="{{URL::action('DocumentoController@show',$documento->num_documento)}}"><i class="icon-eye-open"></i></a> <a href=""><i class="icon-edit"></i></a> </td>
            </tr>
            @endforeach
           </table>
           {{$documentos->render()}}
    ...
    <div class="widgetcontent bordered shadowed nopadding" id="formulario">
        <div class="stdform stdform2">
           ...
           <h4 class="widgettitle nomargin shadowed">Lista de documentos subidos</h4>
            ...
            <td>{{$archivo->nombre}} {{$documento->apellido}}</td>
            <td>{{$archivo->fecha}}</td>
            <td> <a href="/getfile/1"><i class="icon-eye-open"></i></a> </td>
            </tr>
            @endforeach
           </table>
           {{$archivos->render()}}
